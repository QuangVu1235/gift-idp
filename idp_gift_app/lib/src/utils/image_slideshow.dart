...
import 'indicator_global.dart';

class ImageSlideshowGlobal extends StatefulWidget {
  const ImageSlideshowGlobal({
    Key? key,
...
class _ImageSlideshowState extends State<ImageSlideshowGlobal> {
