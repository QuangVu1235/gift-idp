...
class ProductDetail extends StatefulWidget {
  ProductDetail({Key? key, required this.idCategory, required this.heroTag, required this.title,required this.distributorCode}) : super(key: key);
  String idCategory;
...
class _ProductDetailState extends ViewWidget<ProductDetail, ProductDetailModel> {
  ...
  void initState() {
    ...
    viewModel.getProductByCategoryIdDistributor(widget.idCategory, widget.distributorCode);
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ConstrainedBox(
                    constraints:  BoxConstraints(maxHeight: 35,maxWidth: MediaQuery.of(context).size.width*0.45),
