...
import 'package:idp_gift_app/src/modules/modules_store/cart_gift_exchange/cart_gift_exchange_model.dart';
...
class CartGiftExchange extends StatefulWidget{
  const CartGiftExchange({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _CartGiftExchange();

}
class _CartGiftExchange extends ViewWidget<CartGiftExchange, CartGiftExchangeModel>{
  ...
  @override
  CartGiftExchangeModel createViewModel() => getIt<CartGiftExchangeModel>();
